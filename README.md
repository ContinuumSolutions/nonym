...
> **Read the Whitepaper:**
> [Manifesto](./whitepaper/Manifesto.md) — the philosophy and declaration of cognitive independence
> [Technical Whitepaper](./whitepaper/EK1-Whitepaper.md) — full architecture, all formulas, and protocol specifications
...
Read the [Manifesto](./whitepaper/Manifesto.md) first. Then the [Technical Whitepaper](./whitepaper/EK1-Whitepaper.md). Then open an issue, read the code, or start a discussion. The first 1,000 Kernels are initializing.
